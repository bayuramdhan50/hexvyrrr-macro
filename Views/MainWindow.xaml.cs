...
namespace PbRecoil.Views
{
    public partial class MainWindow : Window
    {
        ...
        private void InitializeSystemTray()
        {
            ...
            var toggleOverlayItem = new Forms.ToolStripMenuItem("Hide / Show HUD Overlay (F5)", null, (s, e) =>
            {
                _viewModel.ToggleOverlay();
            });
            contextMenu.Items.Add(toggleOverlayItem);

            var toggleSettingsItem = new Forms.ToolStripMenuItem("Toggle Menu Pengaturan (F6)", null, (s, e) =>
            {
